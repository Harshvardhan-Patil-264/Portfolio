...
// Configure nodemailer transporter with OAuth2 (Alternative method)
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    type: 'OAuth2',
    user: process.env.EMAIL_USER || 'harsh264patil@gmail.com',
...
app.post('/send-email', async (req, res) => {
  try {
    ...
    // Email options
    const mailOptions = {
      from: process.env.EMAIL_USER || 'harsh264patil@gmail.com',
